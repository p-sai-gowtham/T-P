      ...
      <Card variant="outlined" style={{ backgroundColor: "#5656c9" }}>
        <CardContent>
          <Typography sx={{ fontSize: 40 }} color="text.secondary" gutterBottom>
            {details.username} ({details.reg_no})
          </Typography>
          ...
          <Typography style={{ paddingBottom: "4px" }} variant="h5" component="div">
            Checked Drives: {details.drives.xxxx.checkedDrives} / {details.drives.xxxx.noOfDrives}
          </Typography>
          <Typography style={{ paddingBottom: "4px" }} variant="h5" component="div">
            Selected: {details.drives.xxxx.selected ? "Yes" : "No"}
          </Typography>
        </CardContent>
      </Card>
    </Box>
